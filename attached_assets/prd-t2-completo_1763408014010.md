...
1. **Dominio y modelo de datos**
   ...
   * El modelo relacional (business_models, programs, instructors, pricing_tiers, etc.) está definido conceptualmente en `context/kinesis-database-schema.sql` y en el anexo ER de `Kinesis-Web-y-CMS-Specs.md`.
